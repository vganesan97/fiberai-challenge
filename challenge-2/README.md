...
4. If a company's "Launch" post is available (you'll see one on [Fiber AI's page](https://www.ycombinator.com/companies/fiber-ai)), visit that URL and scrape it as well. Extract that information into another well-structured TypeScript `interface`.
